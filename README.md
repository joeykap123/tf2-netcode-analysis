...
# Overview
This project seeks to analyze various networking principles in Team Fortress 2, a game by Valve. </br>
(i.e., highlight use of UDP creates ambiguity between cheating and simple packet loss, but not main goal of project.)
</br>
